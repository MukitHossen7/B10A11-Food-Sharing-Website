      ...
      <div className=" w-11/12 md:w-11/12 lg:w-11/12 xl:container mx-auto">
        ...
        <div className={`grid sm:grid-cols-1 lg:grid-cols-${layout} gap-6 `}>
          {foods.map((food, idx) => (
            <div
              key={idx}
              className="rounded shadow-md p-4 flex flex-col items-start  hover:shadow-xl transition-shadow"
            >
              <img
                src={food.image}
                alt={food.name}
              ...
              />
              <h2 className="text-xl font-semibold mb-2 ">Momos</h2>
              <p className="text-gray-600 mb-1">Quantity: 10</p>
              <p className="text-gray-600 mb-3">Expire Date: 10/12/2025</p>
